...
interface PhoneCallIconProps extends React.HTMLAttributes<HTMLOrSVGElement> {
  rotate?: number;
  color?: string;
}

const PhoneCallIcon: React.FC<PhoneCallIconProps> = ({ ...props }) => {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      <g clipPath="url(#clip0_503_486)">
        ...
        />
        <path
          d="M11.7083 1.66666C13.4068 1.84563 14.9934 2.59899 16.2056 3.80214C17.4179 5.00529 18.1832 6.58617 18.3749 8.28332"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M11.7083 5C12.5278 5.16161 13.2799 5.56586 13.8669 6.16026C14.4539 6.75466 14.8486 7.51177 14.9999 8.33333"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
