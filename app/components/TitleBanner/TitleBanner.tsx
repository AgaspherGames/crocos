...
const backgroundRight = 'linear-gradient(89.4deg, #00a2e4 1.55%, rgba(5, 0, 228, 0.78) 91.45%),'
const backgroundLeft = 'linear-gradient(90deg, rgba(25, 33, 228, 0.57) 0%, #0971E4 100%), '
